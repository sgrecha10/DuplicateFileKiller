"""
Django settings for duplicate_file_killer project.
...
SECRET_KEY = 'django-insecure-^z5(ofq#q5*%b=domkddmq($m@=2bpznqrnw%#^dz$f)3sk)2v'
...
ROOT_URLCONF = 'duplicate_file_killer.urls'
...
WSGI_APPLICATION = 'duplicate_file_killer.wsgi.application'
